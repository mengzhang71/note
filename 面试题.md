...
在校期间担任计数院实验室助理，活跃在实验室内，成为项目组组长，技术一专多长，有多段项目经验，项目内负责过前后端、深度学习，获得中国软件国家三等奖、大学生计算机设计大赛 省三等奖、蓝桥杯web组 省三等奖等

熟练前端常用技术，熟悉Vue技术栈、uniapp、小程序等；熟悉企业前端代码规范、git管理，了解java、SSM，python中的pytorch、Django框架等
详情可查看我的附件简历，静候您的回复。
